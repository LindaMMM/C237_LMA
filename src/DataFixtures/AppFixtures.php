...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $movie_vision  = new Movie("Visions");
        ...
        $movie_dune  = new Movie("Dune : Deuxième Partie");
        ...
        $movie_unevie  = new Movie("Une vie");
        ...
        $movie_anatomie  = new Movie("Anatomie d'une chute");
        ...
        $movie_restedemain  = new Movie("Il reste encore demain");
        ...
        $movie_heureuxgagnants  = new Movie("Heureux gagnants");
