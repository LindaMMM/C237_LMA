...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $movie_bobmarley  = new Movie("Bob Marley: One love",\DateTimeImmutable::createFromFormat('j-M-Y', '14-Feb-2024') );
        ...
        $movie_bobmarley->setMovieStock(new MovieStock(5));
        ...
        $movie_kung  = new Movie("Kung Fu Panda 4", \DateTimeImmutable::createFromFormat('j-M-Y', '27-Mar-2024'));
        ...
        $movie_kung->setMovieStock(new MovieStock(1));
        $manager->persist($movie_kung);

        $movie_barbie  = new Movie("Barbie", \DateTimeImmutable::createFromFormat('j-M-Y', '19-Jul-2023'));
        ...
        $movie_barbie->setMovieStock(new MovieStock(1));
        $manager->persist($movie_barbie);

        $movie_vision  = new Movie("Visions", \DateTimeImmutable::createFromFormat('j-M-Y', '06-Sep-2023'));
        ...
        $movie_vision->setMovieStock(new MovieStock(1));
        $manager->persist($movie_vision);

        $movie_dune  = new Movie("Dune : Deuxième Partie", \DateTimeImmutable::createFromFormat('j-M-Y', '28-Feb-2024'));
        ...
        $movie_dune->setMovieStock(new MovieStock(1));
        $manager->persist($movie_dune);
        
        $movie_unevie  = new Movie("Une vie", \DateTimeImmutable::createFromFormat('j-M-Y', '21-Feb-2024'));
        ...
        $movie_unevie->addMedia(new Media("affiche", "https://fr.web.img6.acsta.net/c_310_420/pictures/24/01/29/09/23/3346514.jpg", $type_Media_png));
        $movie_unevie->setMovieStock(new MovieStock(1));
        $manager->persist($movie_unevie);

        $movie_bolero  = new Movie("Bolero", \DateTimeImmutable::createFromFormat('j-M-Y', '06-Mar-2023'));
        ...
        $movie_bolero->addMedia(new Media("affiche", "https://fr.web.img5.acsta.net/c_310_420/pictures/24/01/26/11/07/0253122.jpg", $type_Media_png));
        $movie_bolero->setMovieStock(new MovieStock(1));
        $manager->persist($movie_bolero);

        $movie_anatomie  = new Movie("Anatomie d'une chute", \DateTimeImmutable::createFromFormat('j-M-Y', '26-Aug-2024'));
        ...
        $movie_anatomie->setMovieStock(new MovieStock(1));
        $manager->persist($movie_anatomie);

        $movie_restedemain  = new Movie("Il reste encore demain", \DateTimeImmutable::createFromFormat('j-M-Y', '13-Mar-2024'));
        ...
        $movie_restedemain->setMovieStock(new MovieStock(1));
        $manager->persist($movie_restedemain);

        $movie_heureuxgagnants  = new Movie("Heureux gagnants", \DateTimeImmutable::createFromFormat('j-M-Y', '13-Mar-2024'));
        ...
        $movie_heureuxgagnants->setMovieStock(new MovieStock(1));
